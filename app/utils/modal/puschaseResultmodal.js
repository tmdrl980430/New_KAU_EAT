...
import {clickQrImgRecoilState, dateRecoilState, modalRecoilState, qrModalRecoilState, userIdxRecoilState, qrTicketCountRecoilState, logoutmodalRecoilState, jwtRecoilState, isLoginRecoilState, purchasemodalRecoilState} from "../../recoil";

//재사용 가능 제목 component

const PurchaseResultModal = (props) => {
    ...
    return (
        <Modal animationType="fade" transparent={false} visible={purchasemodalState}>
