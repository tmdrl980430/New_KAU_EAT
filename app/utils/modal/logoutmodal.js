...
import {clickQrImgRecoilState, dateRecoilState, modalRecoilState, qrModalRecoilState, userIdxRecoilState, qrTicketCountRecoilState, logoutmodalRecoilState, jwtRecoilState, isLoginRecoilState} from "../../recoil";

//재사용 가능 제목 component

const LogoutModal = (props) => {

    const [lgoutmodalState, setLogoutModalState] = useRecoilState(logoutmodalRecoilState);
    ...
    return (
        <Modal animationType="fade" transparent={false} visible={lgoutmodalState}>
            <View style={styles.bigmodalContainer}>
                <View style={styles.modalContainer}>
                    ...
                    <Text style={styles.descirptionText}>로그아웃{'\n'}하시겠습니까?</Text>
